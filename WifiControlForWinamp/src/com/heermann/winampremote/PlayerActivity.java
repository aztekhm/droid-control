...
public class PlayerActivity extends Activity {
	...
	private OnSeekBarChangeListener volumeChangeListener = new OnSeekBarChangeListener() {
		...
		@Override public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
			if (fromUser) MainActivity.msgService.send(30, progress);
		}
	};
	...
	private OnSeekBarChangeListener progressSongChangeListener = new OnSeekBarChangeListener() {
		...
		@Override public void onStartTrackingTouch(SeekBar seekBar) {}
		@Override public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
			if (fromUser) MainActivity.msgService.send(28, progress * 1000);
		}
	};
	...
	public void toggleRepeat(View v) {
		MainActivity.msgService.send(15);
	}

	public void toggleShuffle(View v) {
		MainActivity.msgService.send(16);
	}

	public void toggleMute(View v) {
		MainActivity.msgService.send(32);
	}

	public void previous(View v) {
		MainActivity.msgService.send(2);
	}

	public void play(View v) {
		MainActivity.msgService.send(4);
	}

	public void pause(View v) {
		MainActivity.msgService.send(5);
	}

	public void stop(View v) {
		MainActivity.msgService.send(6);
	}

	public void next(View v) {
		MainActivity.msgService.send(3);
	}
}
